...
object Constant {
    ...
    const val SURVEY_QUES_DETAIL = 519
    const val EMPLOYEE_DETAIL = 520
    const val SUBMIT_SURVEY_DATA = 521
    const val SURVEY_DETAIL_DATA = 522
    const val VALIDATE_EMPLOYEE = 523
