    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                Log.i(TAG, "Camera focus mode: " + mFocusMode + " is supported on this device.");
            } else {
                Log.i(TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device.");


           /*     parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_AUTO);*/// I have set it but still not work
