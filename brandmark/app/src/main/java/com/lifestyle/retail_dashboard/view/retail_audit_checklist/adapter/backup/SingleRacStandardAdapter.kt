...
class SingleRacStandardAdapter(val context: Context, var planogramList: MutableList<GetRACLineItem>) : RecyclerView.Adapter<SingleStandardViewHolder>() {
        ...
        holder.binding.btnSaveUserId.setOnClickListener {
            ...
            if (userId.length >= 7) {
                ...
                if (context is SingleRACDetail) {
                    ...
                    val position = holder.adapterPosition
                    activity.saveAssigneName(Constant.RAC_STANDARD, position, userId);
                }
