...
class RightFilterAdapter(val context: Context, private val rightFilterByList: List<FilterItemSelected>, val onItemSelected: FilterItemSelected.OnItemCheckListener, val itemSelectedList: MutableList<FilterItemSelected>): RecyclerView.Adapter<RightFilterAttendanceViewHolder>() {
