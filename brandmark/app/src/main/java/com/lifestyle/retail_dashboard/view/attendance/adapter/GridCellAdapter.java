...
public class GridCellAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public GridCellAdapter(Context context, int month, int year, OnCalenderListener listener,List<AttendanceDetail> attendanceDetails) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        gridcell = row.findViewById(R.id.tvDate);
        present = row.findViewById(R.id.present);
        cell = row.findViewById(R.id.cell);
        ...
        if (day_color[1].equals("WHITE")) {
            gridcell.setTextColor(_context.getResources().getColor(R.color.text));
            cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" Data not available");
        }

        if (actualDate.get(position).equalsIgnoreCase(today)) {
            gridcell.setTextColor(_context.getResources().getColor(R.color.blue_toggle));
            cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" Data not available");
        }
        ...
        for (AttendanceDetail attendanceDetail : attendanceDetails){
            if (attendanceDetail.getAttnDate() != null
                ...
                if (attendanceDetail.getStatus().equalsIgnoreCase("NOT DEFND"))
                    ...
                    present.setText(attendanceDetail.getStatus());
                ...
                if (attendanceDetail.getStatus().equalsIgnoreCase("P")) {
                    ...
                    cell.setTag("On"+theday + "-" + themonth + "-" + theyear+ " In-Time: "+attendanceDetail.getInTime()+" Out-Time:"+attendanceDetail.getOutTime());
                } else if (attendanceDetail.getStatus().equalsIgnoreCase("A")) {
                    present.setTextColor(_context.getResources().getColor(R.color.red));
                    cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" is Absent");
                }
                    ...
                    present.setTextColor(_context.getResources().getColor(R.color.red));
                    cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" is on Leave");
                }
                else if (attendanceDetail.getStatus().equalsIgnoreCase("H")) {
                    present.setTextColor(_context.getResources().getColor(R.color.green));
                    cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" is Holiday");
                }
                else if (attendanceDetail.getStatus().equalsIgnoreCase("WO")) {
                    present.setTextColor(_context.getResources().getColor(R.color.blue_toggle));
                    cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" is Week Off");
                }
                else if (attendanceDetail.getStatus().equalsIgnoreCase("CO")) {
                    present.setTextColor(_context.getResources().getColor(R.color.green));
                    cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" is Compensatory Off");
                }
                    ...
                    present.setTextColor(_context.getResources().getColor(R.color.red));
                    cell.setTag("On"+theday + "-" + themonth + "-" + theyear+" is Optional Holiday");
                }
                ...
                try {
                    ...
                    if (parsedDate.after(todaysDate)) {
                        ...
                        cell.setBackgroundColor(_context.getResources().getColor(R.color.blue_50));
